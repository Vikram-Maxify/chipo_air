...
const Hero = () => {
  ...
  const handleSearch = async () => {
    ...
    if (tripType === "roundtrip") {
      ...
      const returnSelectedDate = new Date(endDate);

      if (returnSelectedDate < selectedDate) {
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 py-12 md:py-16 lg:py-20">
          ...
          <div className="text-center max-w-4xl mx-auto mb-8 md:mb-12">
            ...
            <p className="text-lg text-blue-100/80 max-w-2xl mx-auto leading-relaxed">
              Search hundreds of airlines to find the best flights for your next
              adventure. Compare prices and book instantly.
            </p>
          </div>
